...
namespace Web\FS\Data;

use InvalidArgumentException;
require __DIR__ . "/BasicDatabaseInterface.php";
require __DIR__ . "/ReadableDatabaseInterface.php";
require __DIR__ . "/WriteableDatabaseInterface.php";
/**
...
class Database implements BasicDatabaseInterface, ReadableDatabaseInterface, WriteableDatabaseInterface
{
    ...
    private function tryConnectDatabase(): void {
        ...
        // try to connect
        $this->conn = pg_connect($this->dsn . ' application_name="Web:RW:script=xyz.php:pid=' . getmypid() . '" ');
